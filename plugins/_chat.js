let handler = m => m; 
 ...
   let responses; 
   if (/^كليفر بحبك|كليفر عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|كليفر هنتجوز امتي|كليفر انت ليا|كليفر بموت فيك$/i.test(m.text)) { 
     responses = [ 
       'شكرا  ',  
       'هفكر في الموضوع',  
             'و انا',  
 ...
     ]; 
   }else if (/^ كليفر عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشبب$/i.test(m.text)) { 
     responses = [ 
